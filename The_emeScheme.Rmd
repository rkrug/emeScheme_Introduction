...
**Github** site of the **emeScheme**: 
[https://github.com/Exp-Micro-Ecol-Hub/emeScheme](https://github.com/Exp-Micro-Ecol-Hub/emeScheme)

```{r, fig.height=2, fig.width=2, echo = FALSE}
qrcode::qrcode_gen('https://github.com/Exp-Micro-Ecol-Hub/emeScheme')
```

**Google Sheet** containing the **emeScheme**: 
[https://docs.google.com/spreadsheets/d/1OAyRM1jGL5Vho-YfPffePhwGpQtaBUeTPJV6P98f0Bc](https://docs.google.com/spreadsheets/d/1OAyRM1jGL5Vho-YfPffePhwGpQtaBUeTPJV6P98f0Bc)

```{r, fig.height=2, fig.width=2, echo = FALSE}
qrcode::qrcode_gen('https://docs.google.com/spreadsheets/d/1OAyRM1jGL5Vho-YfPffePhwGpQtaBUeTPJV6P98f0Bc')
```
